package {
    ...
    public class Template extends Sprite {
        ...
        private function start(ev:Event):void {
            ...
            addChild(debug.display); //Disable this to remove lines
            ...
            textField.defaultTextFormat = new TextFormat("Arial", null, 0x99ff00);
        ...
        protected function mouseDown(ev:MouseEvent):void {
            ...
            if (useHand) {
                ...
                for (var i:uint = 0; i < bodyList.length; i++) {
                    ...
                    if (body.isDynamic() && body.angularVel != 2) {
                        hand.body2 = body;
